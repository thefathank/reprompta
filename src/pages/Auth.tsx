    ...
    >
      ...
      >
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          {isForgot ? "Enter your email and we'll send a reset link." : isLogin ? "Sign in to continue." : "Get started with Reprompta."}
        </p>
        ...
        {isForgot ? (
          <form onSubmit={handleForgotPassword} className="mt-10 space-y-5">
            ...
            <p className="text-xs text-muted-foreground">
              <button type="button" onClick={() => setIsForgot(false)} className="text-foreground hover:underline">
                Back to sign in
              </button>
            </p>
          </form>
          ...
          <form onSubmit={handleSubmit} className="mt-10 space-y-5">
            ...
            <div>
              <div className="mb-1.5 flex items-center justify-between">
                ...
                {isLogin && (
                  <button type="button" onClick={() => setIsForgot(true)} className="text-xs text-muted-foreground hover:text-foreground hover:underline">
                    Forgot password?
                  </button>
                )}
              </div>
